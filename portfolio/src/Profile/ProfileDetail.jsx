...
function ProfileDetail() {
    ...
    function getprofileData() {
        axios.get('https://api.flickr.com/services/rest/?method=flickr.profile.getProfile&api_key=c52862698ac5f596a2562672e990913a&user_id=200608104@N08&format=json')
            .then((response) => {
                var jsonString = response.data.substring(response.data.indexOf('(') + 1, response.data.lastIndexOf(')'));
    ...
    //get flicker images api
    function getprofileImages() {
        axios.get('https://api.flickr.com/services/rest/?method=flickr.people.getPublicPhotos&api_key=c52862698ac5f596a2562672e990913a&user_id=200608104@N08&format=json')
            .then((response) => {
                var jsonString = response.data.substring(response.data.indexOf('(') + 1, response.data.lastIndexOf(')'));
                var jsonObject = JSON.parse(jsonString);
                console.log(jsonObject)
                ...
                jsonObject.photos.photo.map(element => {
                    const imageurl = `https://live.staticflickr.com/${element.server}/${element.id}_${element.secret}.jpg`;
                    console.log(imageurl);
                    setimagearr(prevImageArr => [...prevImageArr, imageurl]);
    ...
    // call functions using useeffect on component mount
    useEffect(() => {
        getprofileData()
        getprofileImages()
    }, [])
                ...
                <>
                    <div id="algn">
                        <div id="card">
                            ...
                            <div id="lower-bg">
                                <div className="text">
                                    <p className="name">{data.profile.first_name} {data.profile.last_name}</p>
                                    <p className="title">{data.profile.profile_description}</p>
                                </div>
                                <div id="icons">
                                    <a href="https://github.com/Sonykmathew" target='_blank' className="ico">
                                    ...
                                    <a href="https://www.linkedin.com/in/sony-k-mathew-aa98711a6/" target='_blank' className="ico">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
